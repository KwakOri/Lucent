...
export const adminLegacyBridgeClass = [
  ...
  '[&_.border-neutral-200]:!border-[#e7e3d3]',
  '[&_.border-primary-500]:!border-[#1a1a2e]',
  '[&_.ring-gray-300]:!ring-[#e7e3d3]',
  '[&_.ring-black]:!ring-[#e7e3d3]',
  '[&_.bg-gray-50]:!bg-[#faf9f3]',
  '[&_.bg-blue-600]:!bg-[#1a1a2e]',
  '[&_.bg-neutral-100]:!bg-[#f5f3e8]',
  '[&_.bg-neutral-50]:!bg-[#faf9f3]',
  '[&_.bg-primary-50]:!bg-[#f5f3e8]',
  '[&_.bg-primary-600]:!bg-[#1a1a2e]',
  ...
  '[&_.text-neutral-700]:!text-[#1a1a2e]/70',
  '[&_.text-neutral-500]:!text-[#1a1a2e]/50',
  '[&_.text-primary-700]:!text-[#a35200]',
  '[&_.text-blue-600]:!text-[#a35200]',
  ...
  '[&_input.rounded-md]:!rounded-[12px]',
  '[&_textarea.rounded-md]:!rounded-[12px]',
  '[&_select.rounded-md]:!rounded-[12px]',
