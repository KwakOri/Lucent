...
const navigationSections: NavigationSection[] = [
  ...
  },
  {
    title: 'v1 카탈로그',
    items: [
      { name: 'v1 아티스트 관리', href: '/admin/artists', icon: Users },
      { name: 'v1 프로젝트 관리', href: '/admin/projects', icon: FolderOpen },
      { name: 'v1 상품 관리', href: '/admin/products', icon: ShoppingBag },
    ],
  },
  {
    title: 'v2 주요 관리',
    items: [
      ...
      { name: 'v2 제작 관리', href: '/admin/production', icon: Package },
      { name: 'v2 배송 관리', href: '/admin/shipping', icon: ArrowLeftRight },
      ...
      { name: 'v2 캠페인 관리', href: '/admin/v2-catalog/campaigns', icon: Megaphone },
      { name: 'v2 통계', href: '/admin/v2-ops/stats', icon: BarChart3 },
    ],
  },
  {
    title: 'v2 기타',
    items: [
      { name: 'v2 번들 관리', href: '/admin/v2-catalog/bundles', icon: Package },
      { name: 'v2 전환 준비', href: '/admin/v2-catalog/readiness', icon: ArrowLeftRight },
      { name: 'v2 미디어·에셋', href: '/admin/v2-catalog/assets', icon: ImageIcon },
      { name: 'v2 Admin Ops', href: '/admin/v2-ops', icon: ShieldCheck },
      { name: 'v2 권한 관리', href: '/admin/v2-ops/rbac', icon: ShieldCheck },
    ],
  },
];
