...
export function ProductVariantManager({ product }: ProductVariantManagerProps) {
  ...
  const newVariantSkuPreview = newVariantTitle.trim()
    ? buildVariantSku({
        ...
        <form className="mt-6 space-y-6" onSubmit={handleCreateVariant}>
          ...
          {newVariantFulfillmentType === 'PHYSICAL' ? (
            ...
            <div className="rounded-2xl border border-blue-100 bg-blue-50 px-4 py-4">
              <p className="text-sm font-medium text-blue-900">오디오 파일 업로드 (선택)</p>
          ...
          <form className="mt-6 space-y-6" onSubmit={handleUpdateVariant}>
            <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_300px]">
              ...
              <div className="rounded-2xl border border-gray-200 bg-gray-50 px-4 py-4">
                ...
                <div className="mt-3 rounded-xl border border-gray-200 bg-white px-4 py-3">
                  <p className="text-sm font-medium text-gray-900">{editingVariantSku}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button type="button" intent="neutral" onClick={resetEditingVariantForm}>
                취소
              </Button>
            </div>
          </form>
                ...
                >
                  <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-1 text-xs text-gray-500">자동 코드 {variant.sku}</p>
