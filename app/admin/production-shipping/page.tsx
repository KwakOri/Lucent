...
const DEFAULT_TAB: UnifiedManagementTab = 'production-candidates';
  ...
  return (
    <div className="space-y-6">
      <header className="space-y-2">
        <h1 className="text-2xl font-bold text-gray-900">제작 / 배송 관리</h1>
        <p className="text-sm text-gray-600">
          제작과 배송 운영을 하나의 페이지에서 탭으로 전환하며 관리합니다.
        </p>
      </header>
